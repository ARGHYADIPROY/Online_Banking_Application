...
<div id="content">
    ...
    <section class="banner1 pt-4 oversease-banner" id="product-banner" style="padding-top: 1.5rem !important;">
      <div class="container">
        <div class="row">
         ...
         <p id="banner-long-title" class="primary-text-color font-weight-bold text-uppercase" style="color: grey;font-size: 40px;font-weight: bolder;">OUR MISSION</p>
         ...
         <div class="col-lg-8 order-1 order-sm-1 order-md-1 order-lg-2 pr-0 pr-mob-grid"><picture data-fileentryid="525059">
           <img class="img-fluid boder-img product-detail-banner" alt="About us" title="About us" data-fileentryid="525059" src="images/6.jpg">
          </picture>
         </div>
        </div>
       </div>
    ...
    <footer style="background-color: rgba(255, 255, 255, 0); margin-bottom: 0;">
        <p style="text-align: center;font-size: 40px;font-weight: bold; color: rgb(255, 255, 255); text-shadow: 2px 2px rgb(255, 23, 23);">Connect With Us</p>
