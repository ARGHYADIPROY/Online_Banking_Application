...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: rgb(168, 94, 236);">
    ...
    <a href="aboutus.php" <?php if ($current_page === "aboutus") echo 'class="active"'; ?>>About Us</a>
      ...
      <div style="text-align: center;margin-left:200px"><p class="text-center" style="font-size: 40px;text-shadow:2px 2px ; font-family:Arial, Helvetica, sans-serif;font-weight:bolder;text-align:center">Transaction History</p>
      <div class="container">
        <div class="card w-75 mx-auto"style="border: 1px solid black;">
          <div class="card-body" style="background-color: #413194;color: white;">
            <table class="table table-hover" style="border: 1px solid black;color: white;">
              ...
              <tbody style="border: 1px solid black;background-color:#b77bc9;color:black">
