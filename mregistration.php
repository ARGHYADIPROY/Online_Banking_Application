...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(153, 0, 0);">
    ...
    <div class="container mt-5">
        <div class="card col-md-11 text-center shadow" style="margin-left: 172px;">
            <div class="card-header" style="background-color: brown; color: white;background-color: rgb(153, 0, 0); color: white; font-size: larger; border: 1px solid black;">
                New Account Form
            </div>
            <div class="card-body" style="background-color: #e06e09;">
                <form method="POST">
                    <table class="table" style="color: black;border:1px solid #e06e09">
                        <tbody >
                            <tr>
                                <th>Name</th>
